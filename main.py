...
# FastAPI 앱 설정
app = FastAPI(title="[VSP]IOT BOX 관리 시스템", description="BOX 관리를 위한 API")
    ...
    <body class="bg-gray-100 min-h-screen">
        <div class="gradient-bg text-white py-6 mb-8">
            <div class="container mx-auto px-6">
                ...
                <p class="mt-2 text-blue-100">IOT BOX 관리 도구</p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-8 card-hover">
                ...
                <form id="computerForm" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">메인 설비</label>
                            <input type="text" id="main" placeholder="A158A" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">공정 *</label>
                            <input type="text" id="process" placeholder="PKG / TEST / SPKG" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">수정자 *</label>
                            <input type="text" id="modifier" placeholder="장민오" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-8 card-hover">
                ...
                <div class="flex space-x-3">
                    <input type="text" id="searchInput" placeholder="MAC, IP, 메인설비, 공정명으로 검색..." 
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">공정</th>
